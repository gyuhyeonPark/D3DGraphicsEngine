...
void RenderManager::Init(shared_ptr<Shader> shader)
{
	...
	_globalEffectBuffer = shader->GetConstantBuffer("GlobalBuffer");	// ���̴� ���Ͽ��� �����´�.
	
	_transformBuffer = make_shared<ConstantBuffer<TransformDesc>>();
	_transformBuffer->Create();
	_transformEffectBuffer = shader->GetConstantBuffer("TransformBuffer");	// ���̴� ���Ͽ��� �����´�.

	_lightBuffer = make_shared<ConstantBuffer<LightDesc>>();
	_lightBuffer->Create();
	_lightEffectBuffer = shader->GetConstantBuffer("LightBuffer");	// ���̴� ���Ͽ��� �����´�.

	_materialBuffer = make_shared<ConstantBuffer<MaterialDesc>>();
	_materialBuffer->Create();
	_materialEffectBuffer = shader->GetConstantBuffer("MaterialBuffer");	// ���̴� ���Ͽ��� �����´�.
